        ...
        {isLoggedIn ? (
          <div className="Mypage_Logout" align="right">  
            ...
            <button type="button" className="btn btn-success" style={{ marginRight: '10px', marginBottom: '15px'}}>
              <Link to="/user/mypage" style={{ color: 'white', textDecoration: 'none' }}>예약정보</Link>
            </button>
          </div>
        ) : (
            ...
            <button type="button" className="btn btn-danger" style={{ marginRight: '10px', marginBottom: '15px'}}>
              <Link to="/user/login" style={{ color: 'white', textDecoration: 'none' }}>로그인</Link>
            </button>      
            <button type="button" className="btn btn-primary" style={{ marginRight: '10px', marginBottom: '15px'}}>
              <Link to="/user/signup" style={{ color: 'white', textDecoration: 'none' }}>회원가입</Link>
            </button> 
            ...
            <button type="button" className="btn btn-success" style={{ marginRight: '10px', marginBottom: '15px'}}>
              <Link to="/user/mypage" style={{ color: 'white', textDecoration: 'none' }}>마이페이지(테스트)</Link>
            </button> 
          </div>
