...
const OffCanvasButton = () => {
        ...
        <div className="container-fluid">
          ...
          <div className="offcanvas offcanvas-end text-bg-dark" tabIndex="-1" id="offcanvasNavbarDark" aria-labelledby="offcanvasNavbarDarkLabel">
            ...
            <div className="offcanvas-body">
              ...
              <li className="mb-1">
          <button className="btn" style={{backgroundColor:'white!important',marginLeft:'-15px'}} data-bs-toggle="collapse" data-bs-target="#home-collapse" aria-expanded="true">
           승차권 예매 
          </button>
  ...
  <button className="btn" style={{ backgroundColor: 'white!important', marginLeft: '-15px', padding: '5px 10px', fontSize: '14px' }} data-bs-toggle="collapse" data-bs-target="#home-collapse" aria-expanded="true">
    승차권 예매 <span style={{ fontSize: '12px' }}>▼</span>
  </button>
  <div className="collapse show" id="home-collapse">
    <ul className="btn-toggle-nav list-unstyled fw-normal pb-1 small" style={{ display: 'flex', flexDirection: 'column' }}>
      ...
      <li><a href="#" id="plane" className="link-body-emphasis d-inline-flex text-decoration-none rounded">항공</a></li>
        ...
        <li className="mb-1">
        <button className="btn" style={{backgroundColor:'white!important',marginLeft:'-15px'}}  data-bs-toggle="collapse" data-bs-target="#dashboard-collapse" aria-expanded="false">
          조회 / 취소 <span style={{ fontSize: '12px' }}>▼</span>
          </button>
          <div className="collapse show" id="dashboard-collapse">
            <ul className="btn-toggle-nav list-unstyled fw-normal pb-1 small" style={{ display: 'flex', flexDirection: 'column' }}>
              ...
              <li><a href="#" id = "cancel" className="link-body-emphasis d-inline-flex text-decoration-none rounded">예약 취소</a></li>
                ...
                <li className="nav-item">
                  <a className="nav-link" href="#">버스 터미널정보</a>
                </li>
                <li className="nav-item">
                  <a className="nav-link" href="#">기차역정보/노선도</a>
                </li>
                <li className="nav-item">
                  <a className="nav-link" href="#">안내 공항 서비스</a>
                </li>
