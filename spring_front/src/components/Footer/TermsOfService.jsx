...
const TermsOfService = () => {
    return (
        ...
        <div className="terms-container">
          ...
          <div className="term-section">
            <p className="term-title">제2조(여행의 종류 및 정의)</p>
            <p className="term-text">
          ...
          <div className="term-section">
            <p className="term-title">제3조(여행사와 여행자 의무)</p>
            <p className="term-text">
          ...
          <div className="term-section">
            <p className="term-title">제4조(계약의 구성)</p>
            <p className="term-text">
          ...
          <div className="term-section">
            <p className="term-title">제5조(계약체결 거절)</p>
            <p className="term-text">
          ...
          <div className="term-section">
            <p className="term-title">제6조(특약)</p>
            <p className="term-text">
          ...
          <div className="term-section">
            <p className="term-title">제7조(계약서 등 교부 및 안전정보 제공)</p>
            <p className="term-text">
          ...
          <div className="term-section">
            <p className="term-title">제8조(계약서 및 약관 등 교부 간주)</p>
            <p className="term-text">
          ...
          <div className="term-section">
            <p className="term-title">제9조(여행요금)</p>
            <p className="term-text">
          ...
          <div className="term-section">
            <p className="term-title">제10조(여행조건의 변경요건 및 요금 등의 정산)</p>
            <p className="term-text">
          ...
          <div className="term-section">
            <p className="term-title">제11조(여행자 지위의 양도)</p>
            <p className="term-text">
          ...
          <div className="term-section">
            <p className="term-title">제12조(여행사의 책임)</p>
            <p className="term-text">
          ...
          <div className="term-section">
            <p className="term-title">제13조(여행출발 전 계약해제)</p>
            <p className="term-text">
          ...
          <div className="term-section">
            <p className="term-title">제14조(최저행사인원 미 충족시 계약해제)</p>
            <p className="term-text">
          ...
          <div className="term-section">
            <p className="term-title">제15조(여행출발 후 계약해지)</p>
            <p className="term-text">
